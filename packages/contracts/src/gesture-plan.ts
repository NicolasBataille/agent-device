...
/**
 * PROTOTYPE: one uninterrupted contact for reorder-style hold, move, hold, release.
 * Element targets are resolved by the runtime before this portable planning seam.
 */
export function buildHoldDragGesturePlan(
  input: {
    from: Point;
    to: Point;
    sourceHoldMs?: number;
