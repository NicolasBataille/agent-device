...
import { issueSettleObservationRefs, resolveRefStalenessWarning } from '../session-snapshot.ts';
...
async function buildTargetedTouchResponsePayloads(params: {
  ...
  return buildInteractionResponseData({
    ...
    settleRefsGeneration: issueSettleObservationRefs(session, result.settle),
  });
}
