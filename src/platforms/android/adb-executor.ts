...
import type { AndroidImeHelperArtifact } from './ime-helper-types.ts';
...
export type AdbFailureClassification = Readonly<{
  reason:
    | 'timeout'
    | 'device_offline'
    | 'device_unauthorized'
...
type AdbFailureMatcher = AdbFailureClassification &
  Readonly<{ pattern: RegExp; matchStdout?: boolean }>;
...
const ANDROID_ADB_TIMEOUT_FAILURE: AdbFailureClassification = Object.freeze({
  reason: 'timeout',
