...
Use `client.sessions.artifacts({ provider, providerSessionId })` with `closed.provider?.providerSessionId` to fetch provider-hosted video and log URLs after close. See the [BrowserStack](/agent-device/pr-preview/pr-1716/docs/browserstack.md), [AWS Device Farm](/agent-device/pr-preview/pr-1716/docs/aws-device-farm.md), and [Limrun](/agent-device/pr-preview/pr-1716/docs/limrun.md) guides for provider-specific setup.
