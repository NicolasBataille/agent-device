...
See [Node.js API](/agent-device/pr-preview/pr-1814/docs/client-api.md) for the complete client surface and runnable, typechecked `agent-device` examples.
